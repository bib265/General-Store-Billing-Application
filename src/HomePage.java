...
public class HomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(543, 461));
        setMinimumSize(new java.awt.Dimension(543, 461));
        setResizable(false);
        ...
        jButton4.setText("Bill Report(AW)");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int a;
        a = JOptionPane.showConfirmDialog(this, " Do you want to log out? "," Confirm",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
